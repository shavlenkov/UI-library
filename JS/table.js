...
function dataTable2(config) {
  ...
  button_create.className = "button-success-gradient modal-trigger";
  ...
  button_save.className = "button-success-gradient";
  ...
  .then((data, url=config.apiUrl) => {
    ...
    for (let k = 0; k < data.length; k++) {
      ...
      button_delete.className =  "button-error-gradient";
      
      button_delete.setAttribute("id-button-delete", data[k].id)
      button_delete.innerHTML = "Удалить";

      let button_edit = document.createElement("button");
      button_edit.className =  "button-warning-gradient modal-trigger";
      ...
      button_save_edit.className = "button-success-gradient";
   ...
   document.querySelectorAll("button.button-error-gradient").forEach( function(a) {
